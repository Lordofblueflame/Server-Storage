#ifndef LOCALEDGE_STORAGE_IN_MEMORY_INGEST_STORE_HPP
#define LOCALEDGE_STORAGE_IN_MEMORY_INGEST_STORE_HPP
...
#endif // LOCALEDGE_STORAGE_IN_MEMORY_INGEST_STORE_HPP
