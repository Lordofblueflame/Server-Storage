...
bool run_protocol_wire_tests() {
    ...
    data.frame_crc32c = 0;
    data.hostindexer_frame = {1U, 2U, 3U, 4U};
    ...
    require_true(parsed_data.hostindexer_frame == data.hostindexer_frame, "Data payload mismatch");
